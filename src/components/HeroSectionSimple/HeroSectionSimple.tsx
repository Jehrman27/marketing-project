      ...
      <div className="flex flex-col py-12 px-3 gap-12 md:py-16 md:px-4 md:gap-8 lg:flex-row lg:py-24 lg:px-24 lg:items-center">
        <div className="flex flex-col gap-8 md:gap-16">
          ...
          <div className="flex gap-4 md:gap-8 md:w-[458px] lg:w-[383px]">
            <button className="flex-1 py-3 px-5 rounded-sm shadow-sm border-1 border-neutral-200 bg-white text-neutral-900 text-base font-medium md:py-4">
              Learn more
            </button>
            <button className="flex-1 py-3 px-5 rounded-sm shadow-sm border-1 border-neutral-200 bg-indigo-700 text-white text-base font-medium md:py-4">
              See pricing
            </button>
          </div>
        </div>
